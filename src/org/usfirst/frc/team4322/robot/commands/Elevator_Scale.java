...
public class Elevator_Scale extends Command {
	...
	{
		ticks = RobotMap.ELEVATOR_SCALE_DIST + Robot.elevator.home;
	...
	protected boolean isFinished() {
		...
		return (Math.abs(Robot.elevator.master.getActiveTrajectoryPosition() - RobotMap.ELEVATOR_SCALE_DIST) > 1) && (Robot.elevator.master.getActiveTrajectoryVelocity() == 0);
	}
